package me.liongames6000.tutorial.container;
...
public class ModFurnaceContainer extends Container {
    ...
    /**
     * Logical-client-side constructor, calles from {@link ContainerType#create(IContainerFactory)}
    ...
    private static ModFurnaceTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
        ...
        if(tileAtPos instanceof ModFurnaceTileEntity) return (ModFurnaceTileEntity) tileAtPos;
